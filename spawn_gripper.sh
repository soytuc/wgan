...
#y= $2;
#zr=$3;
isSpawned=$(rosservice call /gazebo/get_model_state gripper base | grep success: | awk {'print $2'});
echo $isSpawned;
...
rosrun gazebo_ros spawn_model -file /root/baxterws/src/baxter_common/baxter_description/urdf/gripper.urdf  -urdf -x $x -y $y -z $z -R $R -P $P -Y $Y  -model gripper; 
